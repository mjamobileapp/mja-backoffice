...
<template>
  <div class="dashboard-shell mx-auto max-w-[1440px] xl:h-[calc(100svh-104px)] xl:flex xl:flex-col xl:overflow-hidden">
    <h1 class="mb-2 text-3xl text-[#111827] font-bold tracking-tight">
      Dashboard
    </h1>

    <section class="grid shrink-0 gap-3 md:grid-cols-2 xl:grid-cols-3">
      <Card class="dashboard-card metric-card">
        <CardHeader class="flex flex-row items-start justify-between p-4 pb-1 space-y-0">
          <div>
            <CardTitle class="text-base text-[#1f2937] font-semibold">
              Jumlah Mitra
            </CardTitle>
            <div class="mt-1 text-2xl text-[#111827] font-bold">
      ...
      <Card class="dashboard-card metric-card md:col-span-2 xl:col-span-1">
        ...
        <CardContent class="px-4 pb-4 pt-0">
          <div class="grid grid-cols-2 mt-3 gap-2 text-xs">
    ...
    <section class="grid mt-3 gap-4 xl:grid-cols-[1.5fr_0.8fr_1fr] xl:min-h-0 xl:flex-1">
      <Card class="dashboard-card bottom-card">
        <CardHeader class="shrink-0 p-4 pb-2">
          <CardTitle class="text-lg text-[#1f2937] font-semibold">
            Tren Transaksi Mitra (6 Bulan Terakhir)
          </CardTitle>
        </CardHeader>
        <CardContent class="min-h-0 flex flex-1 flex-col px-4 pb-4 pt-0">
          ...
          <div class="min-h-0 flex flex-1 flex-col">
            <svg class="min-h-0 w-full flex-1" viewBox="0 0 340 190" preserveAspectRatio="none" aria-hidden="true">
              <defs>
            ...
            <div class="grid grid-cols-6 shrink-0 px-4 text-center text-xs text-[#4b5563]">
      ...
      <Card class="dashboard-card bottom-card">
        ...
        <CardContent class="min-h-0 flex flex-1 flex-col items-center justify-center px-4 pb-4 pt-0">
          <div class="relative h-32 w-32 2xl:h-40 2xl:w-40">
            ...
            <div class="absolute inset-0 flex items-center justify-center text-4xl text-[#111827] font-bold">
              {{ jumlahMesin }}
            </div>
          </div>
      ...
      <Card class="dashboard-card bottom-card">
        ...
        <CardContent class="min-h-0 flex-1 overflow-hidden px-4 pb-4 pt-0">
          <div v-for="item in activityItems" :key="item" class="border-b border-[#edf0f4] py-2 last:border-0">
            <p class="text-sm text-[#374151] font-medium">
              {{ item }}
            </p>
