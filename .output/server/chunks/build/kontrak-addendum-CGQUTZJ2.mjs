...
import { _ as _sfc_main$2$5, a as _sfc_main$d, b as _sfc_main$1$6 } from './TooltipTrigger-BcDIeLJj.mjs';
import { _ as _sfc_main$c } from './TooltipProvider-CFR98U-_.mjs';
import { _ as _sfc_main$8$3, a as _sfc_main$e, b as _sfc_main$5$2, c as _sfc_main$2$6, d as _sfc_main$1$7, e as _sfc_main$4$6, f as _sfc_main$3$4, g as _sfc_main$6$4, h as _sfc_main$7$3 } from './AlertDialogTrigger-DibbDHY2.mjs';
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(_sfc_main$1$3), null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`Add Data Kontrak Addendum`);
                            } else {
                              return [
                                createTextVNode("Add Data Kontrak Addendum")
                              ];
                            }
                          }),
                          _: 1
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/kontrak-addendum/AddData.vue");
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function deleteItem() {
      try {
        const response = await fetch(`${baseUrl}/kontrakAddendum/${props.item.id}`, {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`
          }
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/kontrak-addendum/DeleteData.vue");
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(_sfc_main$1$3), null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`Edit Data Kontrak Addendum`);
                            } else {
                              return [
                                createTextVNode("Edit Data Kontrak Addendum")
                              ];
                            }
                          }),
                          _: 1
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/kontrak-addendum/EditData.vue");
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(ssrRenderComponent(_component_TableHead, null, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`No Kontrak Addendum`);
                                        } else {
                                          return [
                                            createTextVNode("No Kontrak Addendum")
                                          ];
                                        }
                                      }),
                                      _: 1
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      ...
                                      _push6(ssrRenderComponent(_component_TableCell, { class: "font-medium" }, {
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`${ssrInterpolate(item.noKontrakAddendum)}`);
                                          } else {
                                            return [
                                              createTextVNode(toDisplayString(item.noKontrakAddendum), 1)
                                            ];
                                          }
                                        }),
                                        _: 2
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/kontrak-addendum/ListData.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "kontrak-addendum",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full flex flex-col gap-4" }, _attrs))}><div class="flex flex-wrap items-center justify-between gap-2"><h2 class="text-2xl font-bold tracking-tight">Kontrak Addendum</h2></div><div>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/(mon-project)/kontrak-addendum.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=kontrak-addendum-CGQUTZJ2.mjs.map
