import { _ as _sfc_main$2 } from './Auth-BPEN_5Sg.mjs';
import { _ as _sfc_main$3 } from './Label-BBvFeqSn.mjs';
import { _ as _sfc_main$4 } from './Input-CDkjoebz.mjs';
import { c as cn, a as _sfc_main$2$1 } from './server.mjs';
import { _ as _sfc_main$6 } from './Separator-Bs1EkIKE.mjs';
import { defineComponent, withCtx, createTextVNode, createVNode, ref, mergeProps, unref, createBlock, createCommentVNode, openBlock, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs } from 'vue/server-renderer';
import { Loader2 } from 'lucide-vue-next';
import { _ as _sfc_main$5 } from './PasswordInput-B7OtZZ5H.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: unref(cn)("grid gap-6", (_a = _ctx.$attrs.class) != null ? _a : "")
      ...
      _push(ssrRenderComponent(_sfc_main$5, { id: "password" }, null, _parent));
      _push(`</div><div class="grid gap-2">`);
      ...
      _push(ssrRenderComponent(_sfc_main$5, { id: "confirm-password" }, null, _parent));
      _push(`</div>`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_LayoutAuth = _sfc_main$2;
...
//# sourceMappingURL=register-CGSWo9Al.mjs.map
