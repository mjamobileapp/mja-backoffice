    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(ScrollAreaScrollbar), mergeProps(delegatedProps.value, {
        class: unref(cn)(
          ...
          __props.orientation === "vertical" && "h-full w-2.5 border-l border-l-transparent p-px",
          __props.orientation === "horizontal" && "h-2.5 flex-col border-t border-t-transparent p-px",
          props.class
        )
      }, _attrs), {
...
//# sourceMappingURL=ScrollArea-Boh3Id5t.mjs.map
