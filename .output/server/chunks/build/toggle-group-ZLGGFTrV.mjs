...
import { mergeProps, withCtx, createVNode, createTextVNode, defineComponent, provide, computed, unref, renderSlot, inject, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot } from 'vue/server-renderer';
import { useForwardPropsEmits, ToggleGroupRoot, useForwardProps, ToggleGroupItem } from 'radix-vue';
import { t as toggleVariants } from './index-DZ5zl6T4.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(ToggleGroupItem), mergeProps(unref(forwardedProps), {
        class: unref(cn)(unref(toggleVariants)({
          variant: ((_a = unref(context)) == null ? void 0 : _a.variant) || __props.variant,
          size: ((_b = unref(context)) == null ? void 0 : _b.size) || __props.size
        }), props.class)
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
//# sourceMappingURL=toggle-group-ZLGGFTrV.mjs.map
