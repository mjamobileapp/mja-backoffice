...
import { _ as _sfc_main$6 } from './Slider-CywD5bjA.mjs';
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_Slider, {
                    ...
                    max: 100,
                    step: 1,
                    class: ("cn" in _ctx ? _ctx.cn : unref(cn))("w-3/5", (_a = _ctx.$attrs.class) != null ? _a : "")
                  ...
                  return [
                    createVNode("div", { class: "min-h-100px w-full flex items-center justify-center gap-4 md:min-h-200px" }, [
                      createVNode(_component_Slider, {
                        ...
                        max: 100,
                        step: 1,
                        class: ("cn" in _ctx ? _ctx.cn : unref(cn))("w-3/5", (_b = _ctx.$attrs.class) != null ? _b : "")
...
//# sourceMappingURL=slider-Dg1_LJMD.mjs.map
